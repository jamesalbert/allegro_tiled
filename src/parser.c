...
/*
 * takes a path and returns the amount of
 * '../' to return to the root folder
 *
 * example:
 * al_path_to_root("home/user/path") -> "../../"
 *
 * so if your cwd is "home/user/path", then
 * call al_change_directory("../../") to return
 * to /home
 */
 ...
 * Parses a map file
 *
 * you pass it the name of your projects root folder so that
 * if you're using an ide like Netbeans, it won't confuse
 * your dir with the dist directory (e.g. dist/Debug/GNU-Linux-x86/)
 *
